...
export default function POFilters({
  ...
  const tabs = [
    { value: "", label: "সব" },
    ...Object.entries(PO_STATUS_CONFIG).map(([v, c]) => ({ value: v, label: c.label })),
  ];
    ...
    <div className="border-b border-gray-50">
      <div className="flex items-center gap-3 px-5 py-4 flex-wrap">
        <div className="relative flex-1 min-w-[160px]">
          ...
          <input
            type="text"
            placeholder="PO নং বা সরবরাহকারী..."
            value={search}
        ...
        >
          ...
          <option value="expectedDate">প্রত্যাশিত তারিখ</option>
        </select>
      </div>
      ...
      <div className="flex items-center gap-2 px-5 pb-3 flex-wrap">
        ...
        {onOverdueChange && (
          <button
            ...
            style={{
              backgroundColor: showOverdue ? "#DC2626" : "#FEF2F2",
              color: showOverdue ? "#fff" : "#DC2626",
            }}
          >
            বিলম্বিত
          </button>
      ...
      <div className="flex gap-1 px-5 pb-4 overflow-x-auto flex-wrap">
        {tabs.map((tab) => (
          <button
            key={tab.value}
      ...
      {pages > 1 && (
        <div className="flex items-center justify-between px-5 pb-4">
          <span className="text-xs text-gray-500">{total}টি অর্ডার</span>
